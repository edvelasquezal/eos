...
namespace eos
{
    ...
    struct Implementation<AntiKStarLCDAs>
    {
        ...
        const double mu0 = model->m_u_msbar(1.0);

        inline double zeta3para(const double & mu) const
        {
            return
                (zeta3para_0 * std::pow(c_rge(mu), 77.0 / 9.0) * fpara + (6.0 * a1perp_0 * (-1.0 + std::pow(c_rge(mu), 5.0 / 9.0)) * std::pow(c_rge(mu), 8.0) * fperp_0 * (mu0 - ms0)) / (25.0 * M_V) +
                (2.0 * (std::pow(c_rge(mu), 16.0 / 3.0) - std::pow(c_rge(mu), 77.0 / 9.0)) * fperp_0 * (mu0 + ms0)) / (29.0 * M_V)) / fpara;
        }
        ...
        inline double kappa3para(const double & mu) const
        {
            return
                ...
                (2.0 * std::pow(c_rge(mu), 16.0 / 3.0) * (-1.0 + std::pow(c_rge(mu), 29.0 / 9.0)) * fperp_0 * (mu0 - ms0)) / (29.0 * M_V) +
                (6.0 * a1perp_0 * (-1.0 + std::pow(c_rge(mu), 5.0 / 9.0)) * std::pow(c_rge(mu), 8.0) * fperp_0 * (mu0 + ms0)) / (25.0 * M_V)) / fpara;
        }
        ...
        inline double kappa3perp(const double & mu) const
        {
            return
                ...
                (4.0 * std::pow(c_rge(mu), 4.0) * (-1.0 + std::pow(c_rge(mu), 19.0 / 9.0)) * fpara * (mu0 - ms0)) / (19.0 * M_V) +
                (12.0 * a1para_0 * std::pow(c_rge(mu), 55.0 / 9.0) * (-1.0 + std::pow(c_rge(mu), 13.0 / 9.0)) * fpara * (mu0 + ms0)) / (65.0 * M_V)) / fperp(mu);
        }

        inline double omega3perp(const double & mu) const
        {
            return
               ((-42.0 * a1para_0 * (-1.0 + std::pow(c_rge(mu), 5.0 / 9.0)) * std::pow(c_rge(mu), 68.0 / 9.0) * fpara * (mu0 - ms0)) / (25.0 * M_V) +
                (12.0 * a2para_0 * std::pow(c_rge(mu), 73.0 / 9.0) * (-1 + std::pow(c_rge(mu), 13.0 / 9.0)) * fpara * (mu0 + ms0)) / (13.0 * M_V) +
                (14.0 * (std::pow(c_rge(mu), 4.0) - std::pow(c_rge(mu), 73.0 / 9.0)) * fpara *(mu0 + ms0)) / (37.0 * M_V) +
        ...
        {
            return
                (std::pow(c_rge(mu), 4.0) * (3.0 * fpara * (mu0 - ms0) +
                68.0 * a2para_0 * std::pow(c_rge(mu), 5.555555555555555) * fpara * (mu0 - ms0) -
                51.0 * a1para_0 * std::pow(c_rge(mu), 3.5555555555555554) * fpara * (mu0 + ms0) +
                std::pow(c_rge(mu), 7.555555555555555) * (255.0 * fperp_0 * lambda3perp_0 * M_V +
                (-3.0 + 51.0 * a1para_0 - 68.0 * a2para_0) * fpara * mu0 +
        ...
        {
            return
                -3.7780044580452606e-7 * (887490.0 * a1perp_0 * std::pow(c_rge(mu), 8.0 + std::sqrt(865) / 18.0) * fperp_0 * (ms0 - mu0) -
                448070.0 * std::pow(c_rge(mu), (96.0 + std::sqrt(865.0)) / 18.0) * fperp_0 * (ms0 + mu0) -
                89465220.0 * a2perp_0 * std::pow(c_rge(mu), (176.0 + std::sqrt(865)) / 18.0) * fperp_0 * (ms0 + mu0) +
                ...
                27.0 * (-16435.0 + 683.0 * std::sqrt(865.0)) * a1perp_0 -
                306.0 * (-146185.0 + 4961.0 * std::sqrt(865.0)) * a2perp_0) * mu0) +
        ...
        {
            return
                (9.0 * a1perp_0 * ((865.0 - 7.0 * std::sqrt(865.0)) * std::pow(c_rge(mu), 11.38888888888889) - 1730.0 * std::pow(c_rge(mu), 8.0 + std::sqrt(865.0) / 18.0) +
                 (865.0 + 7.0 * std::sqrt(865.0)) * std::pow(c_rge(mu), 11.38888888888889 + std::sqrt(865.0) / 9.0)) * fperp_0 * (mu0 - ms0)) / (147050.0 * std::pow(c_rge(mu), std::sqrt(865.0) / 18.0) * fpara * M_V) -
                ...
                19030.0 * std::pow(c_rge(mu), (96.0 + std::sqrt(865.0)) / 18.0)) * fperp_0 * (mu0 + ms0)) / (1.191105e7 * std::pow(c_rge(mu), std::sqrt(865.0) / 18.0) * fpara * M_V) -
                ...
                5190.0 * std::pow(c_rge(mu), (176.0 + std::sqrt(865.0)) / 18.0)) * fperp_0 * (mu0 + ms0)) / (4325.0 * std::pow(c_rge(mu), std::sqrt(865.0) / 18.0) * fpara * M_V) +
        ...
        {
            return
                (19030.0 * std::pow(c_rge(mu), (96.0 + std::sqrt(865.0)) / 18.0) * fperp_0 * (ms0 - mu0) +
                42879780.0 * a2perp_0 * std::pow(c_rge(mu), (176 + std::sqrt(865)) / 18.0) * fperp_0 *(ms0 - mu0) -
                1261170.0 * a1perp_0 * std::pow(c_rge(mu), 8.0 + std::sqrt(865.0) / 18.0) * fperp_0 * (ms0 + mu0) +
                ...
                8262.0 * (2595.0 + 91.0 * std::sqrt(865.0)) * a2perp_0) * mu0) -
                ...
                (9515.0 - 6707.0 * std::sqrt(865.0) + 729.0 * (865.0 + 7.0 * std::sqrt(865.0)) * a1perp_0 - 8262.0 *(-2595.0 + 91.0 * std::sqrt(865.0)) * a2perp_0) * mu0) +
                6885.0 * fpara * ((865.0 + 26.0 * std::sqrt(865.0)) * lambda3para_0 +
        ...
        {
            return
                -3.7780044580452606e-7 * (448070.0 * std::pow(c_rge(mu), (96.0 + std::sqrt(865.0)) / 18.0) * fperp_0 * (ms0 - mu0) +
                89465220.0 * a2perp_0 * std::pow(c_rge(mu), (176.0 + std::sqrt(865.0)) / 18.0) * fperp_0 * (ms0 - mu0) -
                887490.0 * a1perp_0 * std::pow(c_rge(mu), 8.0 + std::sqrt(865.0) / 18.0) * fperp_0 * (ms0 + mu0) +
                ...
                306.0 * (-146185.0 + 4961.0 * std::sqrt(865.0)) * a2perp_0) * mu0) - 765.0 * fpara * (63.0 * std::sqrt(865.0) * lambda3para_0 +
        ...
        {
            return
                - 3.0 / 20.0 * std::pow(c_rge(mu), 32.0 / 9.0) * a1para_0 -
                std::pow(c_rge(mu), 16.0 / 3.0) * fperp_0 / fpara * (ms0 - mu0) / (4.0 * M_V) +
                std::pow(c_rge(mu), 8.0) * (std::pow(ms0, 2.0) - std::pow(mu0, 2.0)) / (2.0 * std::pow(M_V, 2.0));
        }
        inline double kappa4perp(const double & mu) const
        {
            return
                1.0 / 10.0 * std::pow(c_rge(mu), 8.0 / 3.0) * a1perp_0 +
                std::pow(c_rge(mu), 8.0 / 3.0) * fpara / fperp_0 * (ms0 - mu0) / (12.0 * M_V) -
                std::pow(c_rge(mu), 8.0) * (std::pow(ms0, 2.0) - std::pow(mu0, 2.0)) / (4.0 * std::pow(M_V, 2.0));
        }
    };
    ...
    struct Implementation<KStarLCDAs>
    {
        ...
        {
            return
                (zeta3para_0 * std::pow(c_rge(mu), 77.0 / 9.0) + (6.0 * a1perp_0 * (-1.0 + std::pow(c_rge(mu), 5.0 / 9.0)) * std::pow(c_rge(mu), 8.0) * fperp_0 * (mu0 - ms0)) / (25.0 * M_V) +
                (2.0 * (std::pow(c_rge(mu), 16.0 / 3.0) - std::pow(c_rge(mu), 77.0 / 9.0)) * fperp_0 * (mu0 + ms0)) / (29.0 * M_V)) / fpara;
        }
        ...
        {
            return
                (1261170.0 * a2perp_0 * std::pow(c_rge(mu), 8.0 + std::sqrt(865.0) / 18.0) * fperp_0 * (ms0 - mu0) -
                19030.0 * std::pow(c_rge(mu), (96.0 + std::sqrt(865.0)) / 18.0) * fperp_0 * (ms0 + mu0) -
                42879780.0 * a2perp_0 * std::pow(c_rge(mu), (176.0 + std::sqrt(865.0)) / 18.0) * fperp_0 * (ms0 + mu0) +
                std::pow(c_rge(mu), 11.38888888888889) * (fperp_0 * ((9515.0 + 6707.0 * std::sqrt(865.0) +
                729.0 * (-865.0 + 7.0 * std::sqrt(865.0)) * a1perp_0 +
                8262.0 * (2595.0 + 91.0 * std::sqrt(865.0)) * a2perp_0) * ms0 +
                (9515.0 + 6707.0 * std::sqrt(865.0) - 729.0 * (-865.0 + 7.0 * std::sqrt(865.0)) * a1perp_0 +
                8262.0 * (2595.0 + 91.0 * std::sqrt(865.0)) * a2perp_0) * mu0) -
                6885.0 * fpara * M_V * (6.0 * std::sqrt(865.0) * omega3para_0 +
                (-865.0 + 26.0 * std::sqrt(865.0)) * omega3paratilde_0)) +
                std::pow(c_rge(mu), 11.38888888888889 + std::sqrt(865.0) / 9.0) * (fperp_0 * (-((-9515.0 + 6707.0 * std::sqrt(865.0) +
                729.0 * (865.0 + 7.0 * std::sqrt(865.0)) * a1perp_0 +
                8262.0 * (-2595.0 + 91.0 * std::sqrt(865.0)) * a2perp_0) * ms0) +
                (9515.0 - 6707.0 * std::sqrt(865.0) + 729.0 * (865.0 + 7.0 *std::sqrt(865.0)) * a1perp_0 -
                8262.0 * (-2595.0 + 91.0 * std::sqrt(865.0)) * a2perp_0) * mu0) +
                6885.0 * fpara * M_V * (6.0 * std::sqrt(865.0) * omega3para_0 +
                (865.0 + 26.0 * std::sqrt(865.0)) * omega3paratilde_0))) /
                (1.191105e7 * std::pow(c_rge(mu), std::sqrt(865.0) / 18.0) * fpara * M_V);
        }
