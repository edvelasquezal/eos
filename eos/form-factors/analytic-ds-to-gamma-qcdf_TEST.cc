...
class AnalyticFormFactorD_sToGammaQCDFTest :
    public TestCase
{
    public:
        AnalyticFormFactorD_sToGammaQCDFTest():
            TestCase("analytic_ds_to_gamma_qcdf_test")
        {
        }
        ...
        virtual void run() const
        {
            // Independent numerical reference
            {
                ...
                p["D_s::omega_0@FLvD2022"]  = 0.7;
                p["D_s::mu_0@FLvD2022"]  = 1.3;
                p["D_s->gamma::mu@FLvD2022QCDF"]  = 1.3;
                p["D_s->gamma::mu_h1@FLvD2022QCDF"]  = 4.7;
                p["D_s->gamma::mu_h2@FLvD2022QCDF"]  = 4.5;
                p["D_s->gamma::s_0@FLvD2022QCDF"] = 1.59;
                p["D_s->gamma::M^2@FLvD2022QCDF"] = 1.35;
                p["decay-constant::D_s"] = 0.2499;
                p["mass::D_s"] = 1.96834;
                p["mass::c"] = 1.275;
                p["mass::rho^+"] = 0.7;
                p["D_s::lambda_E^2"] = 0.0625;
                p["D_s::lambda_H^2"] = 0.125;
                p["D_s::LambdaBar"] = 0.5;
                p["D_s::a^phi+_0@FLvD2022"] =  1.868119356054707;
                p["D_s::a^phi+_1@FLvD2022"] =  0.151143197362311;
                p["D_s::a^phi+_2@FLvD2022"] =  1.203196552637887;
                p["D_s::a^phi+_3@FLvD2022"] =  0.429631987348729;
                p["D_s::a^phi+_4@FLvD2022"] =  0.304198191688109;
                p["D_s::a^phi+_5@FLvD2022"] = -0.324469147908141;
                p["D_s::a^phi+_6@FLvD2022"] =  0.381019563820993;
                p["D_s::a^phi+_7@FLvD2022"] = -0.246884872397705;
                p["D_s::a^phi+_8@FLvD2022"] = -0.058121797086248;


                // Diagnostics: check pieces against Mathematica implementation

                AnalyticFormFactorPToGammaQCDF<D_sToGamma> ff(p, Options());
                ...
                static const std::vector<std::pair<double, double>> reference = {
                    ...
                    std::make_pair(0.0527171469619207,  1e-3), // L0_effective(0.81)
                    ...
                    std::make_pair(0.88941106522119,   1e-8), // C at Egamma=0.81
                    std::make_pair(0.92569114368575,   1e-8), // K_inv at Egamma=0.81
                    std::make_pair(0.882916019547774,  1e-8), // U at Egamma=0.81
                    std::make_pair(0.2597033704013,    1e-8), // F_leading_power(0.81)
                    std::make_pair(-0.0465690290256039 + 0.00392626152208998, 1e-5), // xi(0.81)
                    std::make_pair(0.0133804021454904 + 0.0, 1e-6), // delta_xi(0.81)
                };
                ...
                Kinematics k = Kinematics({ { "E_gamma", 0.81 } });
                Options o { {"form-factors", "FLvD2022QCDF"} };
                auto obs_F_V = Observable::make("D_s->gamma::F_V(E_gamma)", p, k, o);
                auto obs_F_A = Observable::make("D_s->gamma::F_A(E_gamma)", p, k, o);
